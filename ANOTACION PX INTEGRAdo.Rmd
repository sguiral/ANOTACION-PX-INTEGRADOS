...
```{r}
P1TLH<-subset(immune.combined, orig.ident=="P1TLH")
P1TLH
```
...
es.max = sctype_score(scRNAseqData = P1TLH[["integrated"]]@scale.data, scaled = TRUE, 
